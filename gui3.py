...
class User_interface:
    ...
    def create_generation(self,list,percent,x1,y1,x2,y2):
        
        '''Creates a New Generation'''
        
        #intializes list where chosen genders will be kept
...
#It setting allele to none  because self.parent is not getting the allele. FIX!!!!''' 
    ...
    def Third_Generation(self):
       ...
       #creates a mother circle
            ...
            #else: self.canvas.create_oval(175, 350,275,450, fill = "black")
                  
            
        
                  
            
        self.create_generation(self.predict2.get_kids(),self.predict2.get_percent(), 0,600,100,700)
